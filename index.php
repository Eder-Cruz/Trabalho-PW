            ...
            <main class="hoc container clear"> 
                ...
                <ul class="nospace group">
                    ...
                    <li class="one_third btmspace-50">
                        <article>
                            <h6 class="heading font-x1"><i class="fa fa-2x fa-database"></i> <a href="http://www.oab-ba.org.br/advogado/tabela-de-honorarios/">TABELA OAB BA</a></h6>
                            <p>Dispõe sobre remuneração dos serviços advocatícios e aprova tabela de honorários advocatícios no Estado da Bahia. [&hellip;]</p>
                        </article>
                    </li>
                    <li class="one_third">
                        <article>
